...
<div class="container">
    ...
    <div class="card" style="text-align: left; padding: 20px; margin-top: 15px;">
    ...
    <div class="card" style="text-align: left; padding: 20px; margin-top: 15px; background-color: #ffe6e6;">
        <h2>Estado del anime</h2>
        <p><strong>Transmisión actual:</strong> Finalizado</p>
        <p>El anime no se encuentra en emisión actualmente, ya que su historia principal fue adaptada completamente, incluyendo su película final.</p>
    </div>

    <div class="card" style="text-align: left; padding: 20px; margin-top: 15px; background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba;">
