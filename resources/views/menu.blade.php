...
@section('content')
    <div class="container">
        ...
        <div class="card">
            ...
            <p><strong>Descripción:</strong> Capitán de la Generación de los Milagros. Tiene una mente estratégica
                impresionante y su habilidad Emperor Eye le permite anticipar los movimientos del rival.</p>
        </div>
        ...
        <div class="card">
            ...
            <p><strong>Descripción:</strong> Puede copiar cualquier técnica que vea (Perfect Copy). Es uno de los jugadores
                más versátiles.</p>
        </div>
        ...
        <div class="card">
            ...
            <p><strong>Descripción:</strong> Jugador extremadamente rápido y dominante. Su estilo es impredecible y difícil
                de defender.</p>
        </div>
        ...
        <div class="card">
            ...
            <p><strong>Descripción:</strong> Tirador perfecto. Puede encestar desde cualquier parte de la cancha con gran
                precisión.</p>
        </div>
        ...
        <div class="card">
            ...
            <p><strong>Descripción:</strong> No destaca físicamente, pero su habilidad de pase y su invisibilidad en la
                cancha lo hacen único.</p>
        </div>
    </div>
@endsection